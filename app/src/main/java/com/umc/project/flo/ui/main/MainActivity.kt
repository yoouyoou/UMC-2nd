package com.umc.project.flo.ui.main
...
import com.umc.project.flo.ui.main.home.HomeFragment
import com.umc.project.flo.ui.main.locker.LockerFragment
import com.umc.project.flo.ui.main.look.LookFragment
import com.umc.project.flo.ui.main.search.SearchFragment
import com.umc.project.flo.ui.song.SongActivity
...
//                        0, 60, false, "music_lilac")
   ...
   private fun inputDummySongs(){
        ...
        songDB.songDao().insert(
            Song("Next Level", "aespa", 0, 210, false, "music_next",
        ...
        songDB.songDao().insert(
            Song("BBoom BBoom", "모모랜드", 0, 240, false, "music_bboom",
                R.drawable.img_album_exp5, false)
        )
        songDB.songDao().insert(
            Song("Weekend", "태연(TAEYEON)", 0, 200, false, "music_flu",
                R.drawable.img_album_exp6, false)
        )
